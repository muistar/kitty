...
//        Map<String, Object> catData = new HashMap<>(3);
//        catData.put("method", method);
//        catData.put("headers", headers.toString());
//        catData.put("params", paramValues.toString());
//        return CatTransactionManager.newTransaction(() -> {
//            return doRequest(url, headers, paramValues, encoding, method);
//        }, "NacosHttpCall", url, catData);
//    }
//
//    public static HttpResult doRequest(String url, List<String> headers, Map<String, String> paramValues, String encoding, String method) {
