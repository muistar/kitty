...
//        Map<String, Object> catData = new HashMap<>(4);
//        catData.put("method", "get");
//        catData.put("headers", headers.toString());
//        catData.put("params", paramValues.toString());
//        catData.put("readTimeoutMs", readTimeoutMs);
//        return CatTransactionManager.newTransaction(() -> {
//            try {
//                return doHttpGet(url, headers, paramValues, encoding, readTimeoutMs, isSSL);
//            } catch (IOException e) {
//                throw new RuntimeException(e);
//            }
//        }, "NacosHttpCall", url, catData);
//
//    }
//
//    private static HttpResult doHttpGet(String url, List<String> headers, List<String> paramValues,
//                                        String encoding, long readTimeoutMs, boolean isSSL) throws IOException {
...
//                                      String encoding, long readTimeoutMs, boolean isSSL) throws IOException {
//        Map<String, Object> catData = new HashMap<>(4);
//        catData.put("method", "post");
//        catData.put("headers", headers.toString());
//        catData.put("params", paramValues.toString());
//        catData.put("readTimeoutMs", readTimeoutMs);
//        return CatTransactionManager.newTransaction(() -> {
//            try {
//                return doHttpPost(url, headers, paramValues, encoding, readTimeoutMs, isSSL);
//            } catch (IOException e) {
//                throw new RuntimeException(e);
//            }
//        }, "NacosHttpCall", url, catData);
//    }
//
//    private static HttpResult doHttpPost(String url, List<String> headers, List<String> paramValues,
//                                         String encoding, long readTimeoutMs, boolean isSSL) throws IOException {
//        String encodedContent = encodingParams(paramValues, encoding);
...
//                                        String encoding, long readTimeoutMs, boolean isSSL) throws IOException {
//        Map<String, Object> catData = new HashMap<>(4);
//        catData.put("method", "delete");
//        catData.put("headers", headers.toString());
//        catData.put("params", paramValues.toString());
//        catData.put("readTimeoutMs", readTimeoutMs);
//        return CatTransactionManager.newTransaction(() -> {
//            try {
//                return doHttpDelete(url, headers, paramValues, encoding, readTimeoutMs, isSSL);
//            } catch (IOException e) {
//                throw new RuntimeException(e);
//            }
//        }, "NacosHttpCall", url, catData);
//    }
//
//    private static HttpResult doHttpDelete(String url, List<String> headers, List<String> paramValues,
//                                           String encoding, long readTimeoutMs, boolean isSSL) throws IOException {
//        String encodedContent = encodingParams(paramValues, encoding);
//        url += (null == encodedContent) ? "" : ("?" + encodedContent);
//        if (Limiter.isLimit(MD5.getInstance().getMD5String(
